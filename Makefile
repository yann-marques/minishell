...
SRC=main.c signal.c lexer.c env_utils.c clear.c lexer_utils.c ms_split.c prompt.c exit.c \
	error.c set_type.c utils.c var_to_value.c $(FT_LIBFT) $(BUILTINS) $(EXECS)
OBJ=$(SRC:.c=.o)
